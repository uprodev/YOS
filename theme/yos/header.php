...
<body <?php body_class() ?>>
    ...
    <header class="header<?= (is_page_template('templates/template-contacts.php') || is_404())?' header--transparent':'';?><?= is_cart()?' shadow':'';?><?= is_checkout()?' shadow header--empty':'';?>" data-header data-popup="lock-padding">
