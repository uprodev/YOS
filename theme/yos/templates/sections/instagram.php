            ...
            <div class="swiper" data-slider="instagram">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="#" class="instagram-card">
                            <div class="instagram-card__img ibg">
                                <img src="<?= get_template_directory_uri();?>/img/photo/instagram-1.png" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="instagram-card">
                            <div class="instagram-card__img ibg">
                                <img src="<?= get_template_directory_uri();?>/img/photo/instagram-2.png" alt="">
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="instagram-card">
                            <div class="instagram-card__img ibg">
                                <img src="<?= get_template_directory_uri();?>/img/photo/instagram-3.png" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="instagram-card">
                            <div class="instagram-card__img ibg">
                                <img src="<?= get_template_directory_uri();?>/img/photo/instagram-4.png" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="instagram-card">
                            <div class="instagram-card__img ibg">
                                <img src="<?= get_template_directory_uri();?>/img/photo/instagram-5.png" alt="">
                            </div>
                        </a>
                    </div>
                </div>
